...
import typer
from hazy import __version__
from hazy.example import hello
...
app = typer.Typer(
    name="hazy",
    help="View hazy pictures in the terminal",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(f"[yellow]hazy[/] version: [bold blue]{__version__}[/]")
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the hazy package.",
    ),
):
